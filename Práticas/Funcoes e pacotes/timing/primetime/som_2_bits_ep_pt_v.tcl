...
read_verilog  som_2_bits_ep.vo
current_design som_2_bits_ep
link
...
set_load -pin_load 10 [get_ports { s[0] } ]
set_load -pin_load 10 [get_ports { s[1] } ]
